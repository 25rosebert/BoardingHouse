      ...
      <div class="row"> 
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('user.boarding.store')}}" method="POST" enctype="multipart/form-data" class="appendForm" >
                    @csrf
                    <div class="row">
                ...
                {{-- End of House and Lot Form --}}
                       ...
                       <div class="col-md-12 mt-3">
                         ...
                         <div class="col-md-12 mb-3 mt-3">
                            <button type="submit" class="btn btn-lg btn-primary" style="box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">Submit Property</button>
                         </div>
                    </div>
                </form>         
            </div>

    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}" class="text-muted" style="text-decoration:none">House and Lot Details</a></li>                      
            </ol>
          </nav>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-success">
                        <h2>House and Lot Details</h2>
                        <p>Property Informaton</p>
                    </div>
                    <div class="card-body">                
                            <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body mt-3" id="mapCanvas">

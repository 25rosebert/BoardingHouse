    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}" class="text-muted" style="text-decoration:none">Request Lot Details</a></li>                      
            </ol>
          </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Request Lot From User</h2><hr>
                    </div>
                    <div class="card-body">
                        <form class="form-group">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="" disabled value="{{$properties->name}}" class="form-control">
                                </div>
                                <div class="col-md-6 mb-4">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" name="" disabled value="{{$properties->reqLot->land_size}}" class="form-control">
                                </div>

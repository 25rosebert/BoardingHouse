    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="{{url('pended properties')}}" class="text-muted" style="text-decoration:none">Properties</a></li>                     
              <li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}" class="text-muted" style="text-decoration:none">Boarding House Details</a></li>                      
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Boarding House Details</h2><hr>
                    </div>
                    <div class="card-body">
                        <div class="row">

...
<style>
    ...
    *{
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}" class="text-muted" style="text-decoration:none">Request Boarding House Details</a></li>                      
        </ol>
  </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Request Boarding House From User</h2><hr>
                    </div>
                    <div class="card-body">
                        <form class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                    ...
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->bed}}">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label for="">Rooms</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->rooms}}">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label for="">Livingroom</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->livingroom}}">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label for="">Comfort Room</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->comfortroom}}">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label for="">Kitchen</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->kitchen}}">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label for="">Floor Total</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->floor_total}}">
                                </div>
                                <div class="col-md-3">
                                    <label for="">Floor Area</label>
                                    <input type="text" class="form-control" disabled value="{{$properties->reqBoarding->floor_area}}">
                                </div>
                                 <div class="col-md-3 mb-4">
